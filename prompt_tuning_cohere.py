...
##########################################################################
# prompt_tuning_cohere.py
# Supports Python 3
##########################################################################
# Description:
# This script extracts structured JSON data from unstructured text descriptions
# using Oracle Cloud Infrastructure (OCI) Generative AI Service with Cohere model.
# 
...
# Prepare the chat request - COHERE FORMAT
chat_detail = oci.generative_ai_inference.models.ChatDetails()

# Use CohereChatRequest instead of GenericChatRequest
chat_request = oci.generative_ai_inference.models.CohereChatRequest()
chat_request.message = prompt_template  # Direct message format for Cohere
chat_request.max_tokens = 4000
chat_request.temperature = 0.2  # Lower temperature for more deterministic JSON output
chat_request.frequency_penalty = 0
chat_request.top_p = 0.95
chat_request.top_k = 0  # Required for Cohere models

chat_detail.serving_mode = oci.generative_ai_inference.models.OnDemandServingMode(
    model_id="ocid1.generativeaimodel.oc1.eu-frankfurt-1.amaaaaaask7dceyabdu6rjjmg75pixtecqvjen4x4st4mhs2a4zzfx5cgkmq"
)
...
# Process the response - Cohere format has a different structure
...
json_response = extract_and_save_json(
    response_text, 
    './samples/extracted_tree_data_cohere.json'
)
